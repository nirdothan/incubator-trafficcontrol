...
var trafficPortal = angular.module('trafficPortal', [
        ...
        require('./modules/private/configure/deliveryServices/additionalJson').name,
        ...
        require('./common/modules/table/deliveryServiceAdditionalJson').name,
        ...
        require('./common/directives/ngJsonDiffPatch').name,
